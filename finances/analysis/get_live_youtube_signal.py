# Capture live signals from youtube
# YTB Live Signal: https://www.youtube.com/watch?v=whLEZUvQBVU
# Source: https://stackoverflow.com/questions/43032163/how-to-read-youtube-live-stream-using-opencv-python

from datetime import datetime, timedelta, timezone
import urllib, m3u8, streamlink, cv2, time
...
tempFile = "./analysis/temp.ts"  #files are format ts, open cv can view them
videoURL = "https://www.youtube.com/watch?v=whLEZUvQBVU"
